...
export function IconVolume2({ className, size, style }: IconProps) {
  return (
    <svg {...def(size, className, style)}>
...
/** Speaker muted / zero volume. */
export function IconVolumeX({ className, size, style }: IconProps) {
  return (
    <svg {...def(size, className, style)}>
      <polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5" />
...
export function IconCopy({ className, size, style }: IconProps) {
  return (
    <svg {...def(size, className, style)}>
...
export function IconDownload({ className, size, style }: IconProps) {
  return (
    <svg {...def(size, className, style)}>
...
export function CategoryIcon({ slug, className, size }: { slug: string } & IconProps) {
  switch (slug) {
    ...
    case 'whatsapp-community-cae-show-up':
      return <IconPlay className={className} size={size} />;
